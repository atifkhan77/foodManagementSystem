...
public class Registered_Restaurant2 extends JFrame{
    JLabel l1,l2; 
    JButton b1,b2,b3;
    
    
    Registered_Restaurant2(String s){
        ...
        l1 = new JLabel("=======WELCOME TO REGISTERED RESTAURANT MENU===========");
        p1.add(l1);
        
        b1 = new JButton("Update Name of Restaurant");
    ...
    public class MyActionListener implements ActionListener, Serializable {
        ...
        public void actionPerformed(ActionEvent ae) {
            if(ae.getActionCommand().equals("Update Name of Restaurant")){ 
                
                Update_Name a = new Update_Name(l2.getText());
            }

            if (ae.getActionCommand().equals("Check Your Menu")) {
                dispose();
                Food_Menu f = new Food_Menu(l2.getText());
            }
