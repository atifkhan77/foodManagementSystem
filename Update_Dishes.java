 ...
 * @author Dell
 */
public class Update_Dishes extends JFrame{
    JLabel l1,l2,l3,l4,l5,l6;
    JTextField t1,t2,t3,t4,t5;
    JButton b1,b2;
    
    Update_Dishes(String s){
        ...
        l1 = new JLabel("========WELCOME TO UPDATE FOOD MENU==========");
        ...
        l6 = new JLabel("Enter the name of the food you want to update");
        t5 = new JTextField(30);
        
        JPanel p2 = new JPanel();
        p2.setLayout(new GridLayout(4,2));
        
        p2.add(l6);p2.add(t5);p2.add(l2);p2.add(t1);p2.add(l3);p2.add(t2);p2.add(l4);p2.add(t3);
